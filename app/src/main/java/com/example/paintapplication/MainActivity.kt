...
class MainActivity : AppCompatActivity() {
        ...
        registerForActivityResult(ActivityResultContracts.RequestMultiplePermissions()){
            ...
            if (isGranted){
                ...
                if(permissionName == Manifest.permission.READ_EXTERNAL_STORAGE){
                    Toast.makeText(this@MainActivity, "You just denied permission.",Toast.LENGTH_LONG).show()
                }
            }
        }
        }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val colorPallet = findViewById<LinearLayout>(R.id.colorPallet)
        mImageButtonCurrentPaint = colorPallet[0] as ImageButton
        ...
        ibSave.setOnClickListener {
            if(isReadStorageAllowed()){
                ...
                lifecycleScope.launch {
                    val drawingViewContainer: FrameLayout = findViewById(R.id.drawingViewContainer)
